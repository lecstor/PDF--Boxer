...
<doc name="Main" max_width="595" max_height="842">
  ...
  <column border="1" border_color="red">
    <text border="1" border_color="green">
      PDF::Boxer
    </text>

    <text align="center" border="1" border_color="blue">
      PDF::Boxer
    </text>

    <text align="right" border="1" border_color="green">
      PDF::Boxer
    </text>
    ...
    <row height="200" border="1" border_color="purple">
      <text border="1" border_color="orange">
        PDF::Boxer
      </text>
      <text align="center" border="1" border_color="orange">
        PDF::Boxer
      </text>
    </row>
...
my $spec2 = <<'__EOP__';
<column name="Main" max_width="595" max_height="842" border="1">
...
my $boxer = PDF::Boxer->new( doc => { file => 'test_align.pdf' } );
